...
class Encoder(object):
    def __init__(self, pretrained_model_path, pool_type='max', max_seq_length=40):
        ...
        self.tokenizer = BertTokenizer.from_pretrained(pretrained_model_path, do_lower_case=True,
                                                       cache_dir=pretrained_model_path, use_fast=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_file", default="indices/video/ct_corpus.pt", type=str,
                        help="output file save embeddings")
